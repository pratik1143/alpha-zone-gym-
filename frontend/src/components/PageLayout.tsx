          ...
          <div className="grid md:grid-cols-4 gap-10 items-start text-left">
            ...
            <div className="space-y-4 md:col-span-1">
              ...
              <div className="flex gap-3">
                <a href="https://www.instagram.com/alphazonegym" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 rounded-lg bg-slate-900 border border-white/10 flex items-center justify-center text-slate-400 hover:text-[#d4ff00] hover:border-[#d4ff00]/40 transition-all">
                ...
                <a href="https://www.youtube.com/@Alphazonegym" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-8 h-8 rounded-lg bg-slate-900 border border-white/10 flex items-center justify-center text-slate-400 hover:text-[#d4ff00] hover:border-[#d4ff00]/40 transition-all">
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
