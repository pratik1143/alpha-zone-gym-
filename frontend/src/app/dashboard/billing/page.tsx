...
import { useTodaysPayments, PaymentRecord, getCanonicalISTDate } from '@/hooks/useTodaysPayments';
...
export default function BillingPage() {
  ...
  const payments = useMemo(
    () => [...allPayments].sort((a, b) => {
      const isAutoA = a.isAutoGenerated === true || a.isHistorical === true || a.imported === true;
      const isAutoB = b.isAutoGenerated === true || b.isHistorical === true || b.imported === true;
  ...
  const filteredPayments = useMemo(() => {
    ...
    return payments.filter(p => {
      ...
      // Date Range Filter based on canonical IST payment date
      let matchesDate = true;
      if (dateFilter !== 'all') {
        const pDateStr = getCanonicalISTDate(p.invoiceDate || p.billingDate || p.date || p.paymentDate || p.transactionDate || p.createdAt);
        if (dateFilter === 'today') {
          matchesDate = pDateStr === todayStr;
