            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              >
                ...
                <div className="flex gap-3 pt-2">
                  <a href="#" className="w-9 h-9 rounded-xl bg-slate-950 border border-white/10 flex items-center justify-center text-slate-400 hover:text-[#d4ff00] hover:border-[#d4ff00]/40 transition-all">
